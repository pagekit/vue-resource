...
* **success** - `function(data, status, request)` - Callback function to be called when the request is a success
* **error** - `function(data, status, request)` - Callback function to be called when the request fails
* **always** - `function(data, status, request)` - Callback function to be called when the request finishes
